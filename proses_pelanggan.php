...
if($_POST){
    ...
    if(empty($nama_pelanggan)){
        ...
        echo "<script>alert('kelompok tidak boleh kosong');location.href='register.php';</script>";
    } elseif(empty($password)){
        echo "<script>alert('nama telephone tidak boleh kosong');location.href='register.php';</script>";
